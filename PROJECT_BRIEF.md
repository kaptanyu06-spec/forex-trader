...
**ความชอบผู้ใช้ (2026-07-18)**: ถนัด/ชอบหน้าจอ MT5 มากกว่า — ช่วง demo ให้ใช้ MT5 (บัญชี OANDA MT5 demo) เป็นจอดูกราฟคู่ไปกับระบบ | ตอนออกแบบขั้นเงินจริง ให้พิจารณาโหมดกดยืนยัน Telegram + ผู้ใช้กดเทรดเองใน MT5 เป็นตัวเลือกหลัก (ไม่ต้องมี bridge)
