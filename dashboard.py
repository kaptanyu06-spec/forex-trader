...
# โลโก้แอป (ผู้ใช้เลือกภาพเอง 2026-07-19): ไอคอนแท็บเบราว์เซอร์ + โลโก้มุมซ้ายบน
LOGO_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "assets", "logo.png")
LOGO_SMALL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "assets", "logo_small.png")

st.set_page_config(page_title="Forex Analyzer",
...
st.markdown(f'''<div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
  ...
  <div style="display:flex;align-items:baseline;gap:12px;flex-wrap:wrap;">
    <span style="font-size:1.7rem;font-weight:800;">Trader Automation</span>
    <span style="color:#8b94a7;font-size:.85rem;">ศูนย์วิเคราะห์ Forex · ข่าว + เทคนิค · อัปเดต {updated_txt}</span>
  </div>
</div>''', unsafe_allow_html=True)
